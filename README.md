...
Below button opens [Setup.md](./SETUP.md) in Google Cloud Shell, where you could instantly follow described steps. 
 ...
 [Open in Cloud Shell](https://console.cloud.google.com/cloudshell/open?git_repo=https%3A%2F%2Fgithub.com%2Fnholuongut%2Fbbq&page=shell&tutorial=SETUP.md)
...
* Views (you can use [GCP Census](https://github.com/nholuongut/gcp-census) for that),
* Dataset/table labels as they are not copied by BigQuery copy job (again, you can use [GCP Census](https://github.com/nholuongut/gcp-census) for that)
